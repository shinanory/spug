    ...
    export default {
        ...
        methods: {
            handleSubmit() {
                ...
                localStorage.setItem('is_supper', '1');
                localStorage.setItem('permissions', ['home_view','account_user_view','assets_host_view','publish_app_view','config_environment_view','job_task_view']);
